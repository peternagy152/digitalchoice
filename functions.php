...
function digitalchoice_enqueue_styles() {
    ...
    wp_enqueue_style('digitalchoice-main-style', get_template_directory_uri() . '/assets/css/output.css', array(), time());
    wp_enqueue_style('digitalchoice-global-style', get_template_directory_uri() . '/assets/css/global.css', array(), time());
