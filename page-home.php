    ...
    <div class="relative w-full h-[75vh] flex items-center justify-center bg-cover bg-center"
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32 z-20 relative">
            <p class="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
                Welcome to <span class="border-b border-dotted border-slate-300">CYBERSPACE</span>
            </p>
            ...
            <h1 class="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
                <span class="inline-block">Your
                    <span class="relative whitespace-nowrap text-blue-600">
                        ...
                        <span class="relative">Digital</span></span>
                </span>
                <span class="inline-block">Realm</span>
            </h1>

            <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
                <span class="inline-block">Explore the boundless possibilities</span>
                <span class="inline-block">of the digital world.</span>
            </p>
